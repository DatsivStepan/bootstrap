$(function() {
    ...
    $(window).load(function(){
        if(jQuery.browser.mobile === false){
            $('.player').YTPlayer({
                videoURL: 'https://www.youtube.com/watch?v=LT_RQSaA8G8',
                containment: 'body',
                autoPlay: true, 
                mute: true, 
                startAt: 17, // Set the seconds the video should start at.
                stopAt: 160, // Set the seconds the video should start at.
                opacity: 1
            });
        }
        else{
